...
var I18N = ( function() {
    ...
    var apply = function() {
        ...
        // Get all elements to apply I18N on placeholder
        var plc_elems = $( "*[i18n-placeholder]" );
        plc_elems.each( function( index, object ) {
            var i18n_id = $( object ).attr( 'i18n-placeholder' );
            // Get value
            var i18n_val = I18N.resolve( i18n_id );
            // Set the placeholder text
            $( object ).attr( { placeholder: i18n_val } );
        } );
    };
